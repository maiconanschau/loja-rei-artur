...
--
-- Servidor: localhost
-- Tempo de Geração: Set 07, 2009 as 09:44 
...
(1, 'Camisas', 'Camisas confortáveis sem perder a elegância', 1),
(2, 'Gravatas', 'Gravatas nos mais diversos estilos, do tradicional ao moderno', 1),
(3, 'Ternos', 'Ternos para todas as ocasiões: casamentos,eventos formais e informais', 1),
(4, 'Calças', 'Calças nos mais diversos tamanhos e cores', 1),
(5, 'Sapatos', 'Sapatos em couro com durabilidade e conforto', 1),
(6, 'Acessórios', 'Cintos, pregadores, lenços, calçadores e muitos outros', 1);
...
(1, 1, 'txgruppi@gmail.com', 'be499017489faf269a474dc5d09067f5', NULL, 2147483647, 'Tarcísio', 1);
...
(1, 'Tarcísio Xavier Gruppi', 2147483647, 'M', '1987-04-21');
