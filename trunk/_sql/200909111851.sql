...
--
-- Servidor: localhost
-- Tempo de Geração: Set 11, 2009 as 06:51 
...
--
-- Extraindo dados da tabela `clientebonus`
--

INSERT INTO `clientebonus` (`idBonus`, `idCliente`, `valorBonus`, `origemBonus`, `dataBonus`) VALUES
(2, 1, '100.00', 'questionarioSocioEconomico', '2009-09-11 17:42:12');
...
(1, 'Tarcisio Xavier Gruppi', 2147483647, 'M', '1987-04-21');
...
INSERT INTO `comentario` (`idComentario`, `conteudoComentario`, `statusComentario`, `dataComentario`, `idCliente`, `idProduto`) VALUES
(1, 'Muito bom este produto', 0, '2009-09-09 18:24:11', 1, 3),
(2, 'Inus Perago tui Pronuntio per pio vel superstes sperno. Spero nascor circumvenio ius ineo beneficentia. Sui Innotesco sui cui Lentus perago sem hic Trepido lucus nox fas nos effor via et, appello sed appositus at carus indissolubilis servitium ora lac Vehemens, ita Silex dis Concateno quo sis cur. Cui Concite hic daps, pes cui distinguo crocotula ruo. Sors emitto depopulo Sedulo formido via spero ortus Sarcalogos, vos excello omnis minuo cui Praebeo per nox hic Capulatio. No consentaneus ibi Subsanno ago quibus vos crustulum tam pala Infremo sem Crebra pro ius Perstruo. Vomer tractare proceritas reciproca obex per Hereditas tot Ver peto ait Emiror effluo incrementabiliter Manipulus basilicus cur repletus duo Industria ira via. Heu fas gelidus. Is ius Multi rex. Seu pax. Succumbo laxe improvidus Succendo pax ne dum eo. Eia. Devotio moderamen Gemblacensis Opportune sui improbitas peto upilio Castanea ivi Vindex per tui Marcieniensis Inhalo dux Devio res prodigiosus non ita Celeritas, d.', 0, '2009-09-09 18:26:06', 1, 3),
(3, 'Inus Perago tui Pronuntio per pio vel superstes sperno.\r\nSpero nascor circumvenio ius ineo beneficentia.\r\nSui Innotesco sui cui Lentus perago sem hic Trepido lucus nox fas nos effor via et, appello sed appositus at carus indissolubilis servitium ora lac Vehemens, ita Silex dis Concateno quo sis cur.\r\nCui Concite hic daps, pes cui distinguo crocotula ruo.\r\nSors emitto depopulo Sedulo formido via spero ortus Sarcalogos, vos excello omnis minuo cui Praebeo per nox hic Capulatio.\r\nNo consentaneus ibi Subsanno ago quibus vos crustulum tam pala Infremo sem Crebra pro ius Perstruo.\r\nVomer tractare proceritas reciproca obex per Hereditas tot Ver peto ait Emiror effluo incrementabiliter Manipulus basilicus cur repletus duo Industria ira via.\r\nHeu fas gelidus.\r\nIs ius Multi rex.\r\nSeu pax.\r\nSuccumbo laxe improvidus Succendo pax ne dum eo.\r\nEia.', 0, '2009-09-09 18:27:24', 1, 3),
(4, 'Muito bom!', 0, '2009-09-10 20:31:29', 2, 15),
(5, 'Bom', 0, '2009-09-10 20:52:00', 2, 15),
(6, 'Sapato confortavel ', 0, '2009-09-11 12:48:25', 4, 15);
...
INSERT INTO `opcaopergunta` (`idOpcao`, `idPergunta`, `valorOpcao`) VALUES
(1, 5, 'OpÃ§Ã£o 1\r'),
(2, 5, 'OpÃ§Ã£o 2\r'),
(3, 5, 'OpÃ§Ã£o 3'),
(4, 6, 'Multipla 1\r'),
...
INSERT INTO `perguntaquestionario` (`idPergunta`, `textoPergunta`, `tipoPergunta`, `ordemPergunta`, `ativoPergunta`) VALUES
(1, 'Pergunta do campo de Texto', 1, NULL, 1),
(2, 'Pergunta de caixa de texto', 2, NULL, 1),
(6, 'Pergunta de seleÃ§Ã£o multipla', 4, NULL, 1),
(5, 'Pergunta de lista de seleÃ§Ã£o', 3, NULL, 0),
(7, 'Pergunta de seleÃ§Ã£o unica', 5, NULL, 1);
...
INSERT INTO `questionariocliente` (`idCliente`, `idPergunta`, `respostaPergunta`) VALUES
(1, 6, '4'),
(1, 2, 'Lorem ipsum\r\nDolor sit\r\nAmet'),
(1, 1, 'Lorem ipsum'),
(1, 6, '6'),
